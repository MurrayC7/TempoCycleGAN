...
from TensorFlow.model import CycleGAN
from datetime import datetime
import os
import logging
from TensorFlow.utils import ImagePool
...
def train():
    ...
    with graph.as_default():
        ...
        # tempo 6/22
        G_loss, D_Y_loss, F_loss, D_X_loss, fake_y, fake_x, \
        G_t_loss, D_Y_t_loss, F_t_loss, D_X_t_loss, fake_y_t, fake_x_t = cycle_gan.model()

        s_optimizers = cycle_gan.optimize(G_loss, D_Y_loss, F_loss, D_X_loss)
        t_optimizers = cycle_gan.optimize(G_t_loss, D_Y_t_loss, F_t_loss, D_X_t_loss)
